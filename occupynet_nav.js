...
navObj.outHtml += '		<li class="onav_top onav-directory"><a href="http://Directory.occupy.net/" target="_blank" title="">Directory</a></li>';
navObj.outHtml += '     <li class="onav_top onav-wiki"><a href="http://Wiki.occupy.net/" target="_blank" title="">Wiki</a></li>';
navObj.outHtml += '     <li class="onav_top onav-notes"><a href="http://Notes.occupy.net/" target="_blank" title="">Notes</a></li>';
navObj.outHtml += '     <li class="onav_top onav-ideas"><a href="http://Ideas.occupy.net/" target="_blank" title="">Ideas</a></li>';
// navObj.outHtml += '     <li class="onav_top"><a href="http://lists.occupy.net/" target="_blank" title="">Lists</a></li>';
navObj.outHtml += '     <li class="onav_top onav-map"><a href="http://Map.occupy.net/" target="_blank" title="">Map</a></li>';
navObj.outHtml += '     <li class="onav_top onav-campaigns"><a href="http://Campaigns.occupy.net/" target="_blank" title="">Campaigns</a></li>';
navObj.outHtml += '     <li class="onav_top onav-classifieds"><a href="http://Classifieds.occupy.net/" target="_blank" title="">Classifieds</a></li>';
